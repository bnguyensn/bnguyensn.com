...
function ContactIcon(props: ContactIconType) {
    const {href, d, fill, ...rest} = props;
    return (
        <div className="contact-icon" {...rest}>
            <a href={href}>
