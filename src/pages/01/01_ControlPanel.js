...
class ControlPanel extends Component {
    ...
    actionPostMessage(e) {
        this.setState((prevState, props) => {
            return {postMsgClicked: !prevState.postMsgClicked}
        });
    }
    ...
    render() {
        let cp_bar_cls = classnames({
            'cp-bar': true,
            'min-width-100p': this.state.postMsgClicked
        });

        return (
            <div className='cp-canvas'>
                <div className={cp_bar_cls}>
                    <Button name='btn-msg' icon='message' handleClick={this.actionPostMessage} />
